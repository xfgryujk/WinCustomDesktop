...
namespace cd
{
	...
	// 窗口过程的事件
    extern CD_API PreEvent<UINT, WPARAM, LPARAM, LRESULT&, bool&>  g_fileListWndProcEvent;		 // 参数：message, wParam, lParam, 返回值, 不取消
	extern CD_API PreEvent<UINT, WPARAM, LPARAM, LRESULT&, bool&>  g_parentWndProcEvent;		 // 参数：message, wParam, lParam, 返回值, 不取消
	extern CD_API PreEvent<UINT, WPARAM, LPARAM, LRESULT&, bool&>  g_topWndProcEvent;		     // 参数：message, wParam, lParam, 返回值, 不取消
}
